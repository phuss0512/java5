    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card my-3 ">
                ...
                <div class="card-body">
                    <sf:form action="/khach-hang/update/${ma}" method="POST" modelAttribute="kh">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput10" class="form-label">Số điện thoại</label>
                            <span style="color: red ">*</span>
                            <sf:input type="text" class="form-control" id="exampleFormControlInput10" redname="sdt"
                                      path="sdt"/>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput9" class="form-label">Mật khẩu</label>
                            <span style="color: red ">*</span>
                            <sf:input type="password" class="form-control" id="exampleFormControlInput9" redname="matKhau"
                                      path="matKhau"/>
